...
[![Build Status](https://travis-ci.org/aetheon/node-opensubtitles-client.png?branch=master)](https://travis-ci.org/aetheon/node-opensubtitles-client) [![RSS](http://site.divhide.com/assets/img/rss_16x16.png)](http://feeds.feedburner.com/divhide)
